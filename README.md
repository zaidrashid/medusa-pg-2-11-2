...
3. Set the admin credentials
    ...
    ```
4. By default, the seed data will be implemented. So you will have a single region. Set the region accordingly in the admin panel
    ![Screenshot](2025-11-03_10-16.png)
5. Fetch the products, including the variants calculated price.
    ```bash
